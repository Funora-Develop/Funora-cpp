<p align="center">
  <img src="https://raw.githubusercontent.com/Funora-Develop/.github/main/assets/funora-cpp.svg" width="76" height="76" alt="">
</p>

<h1 align="center">Funora для C++</h1>

<p align="center"><em>C++ SDK.</em></p>
...
Начинается только после того, как контракты протокола и домена перестанут меняться: ранняя реализация на C++ превратила бы любую правку модели в ломающую. Совместимость на уровне исходников, а не ABI, и это будет заявлено прямо, а не подразумеваться.
